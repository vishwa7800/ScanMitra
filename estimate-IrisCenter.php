...
<head>
  <meta charset="UTF-8">
  <title>IrisCenter Queue Estimate</title>
  <style>
    /* ========================
       GLOBAL STYLES
    ======================== */
...
<body>
  ...
  <!-- ===== Main Card Content ===== -->
  <div class="container">
    <h2>IrisCenter Queue Estimate</h2>

    <!-- Queue Information (updated for diagnostic center) -->
    <p><strong>People ahead of you:</strong> <span class="highlight">1</span></p>
    <p><strong>Your estimated wait:</strong> <span class="highlight">~30 mins</span> <span style="font-size:14px;color:#ffd700;">(based on services booked ahead)</span></p>
    <p><strong>Slots left today:</strong> <span class="highlight">7</span></p>
