...
<head>
  <meta charset="UTF-8">
  <title>Sahara Queue Estimate</title>
  <style>
    /* ========================
       GLOBAL STYLES
    ======================== */
...
<body>
  ...
  <!-- ===== Main Card Content ===== -->
  <div class="container">
    <h2>Sahara Queue Estimate</h2>

    <!-- Queue Information (updated for diagnostic center) -->
    <p><strong>People ahead of you:</strong> <span class="highlight">5</span></p>
    ...
    <p><strong>Slots left today:</strong> <span class="highlight">0</span></p>
