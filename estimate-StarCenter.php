...
<head>
  <meta charset="UTF-8">
  <title>StarCenter Queue Estimate</title>
  <style>
    /* ========================
       GLOBAL STYLES
    ======================== */
...
<body>
  ...
  <!-- ===== Main Card Content ===== -->
  <div class="container">
    <h2>StarCenter Queue Estimate</h2>

    <!-- Queue Information (updated for diagnostic center) -->
    <p><strong>People ahead of you:</strong> <span class="highlight">2</span></p>
    <p><strong>Your estimated wait:</strong> <span class="highlight">~45 mins</span> <span style="font-size:14px;color:#ffd700;">(based on services booked ahead)</span></p>
    <p><strong>Slots left today:</strong> <span class="highlight">5</span></p>
